...
export class HeadquartersUseCases {
    ...
    async createHeadquarters(hq: Headquarters, user: Pick<UserHeadquarters, 'userId'>): Promise<Headquarters> {
        return this.db.createHeadquarters(hq, user.userId);
    }

    async getHeadquarters(params: Pick<Headquarters, 'headquartersId'>): Promise<Headquarters | undefined> {
