...
export interface DatabaseAdapter {
  ...
  // Headquarters
  getHeadquarters(): Promise<Headquarters[]>;
  ...
  updateHeadquarters(id: string, updates: Partial<Headquarters>): Promise<Headquarters>;
  ...
  updateRequestStatus(id: string, status: RequestStatus, headquartersId: string): Promise<AppRequest>;
