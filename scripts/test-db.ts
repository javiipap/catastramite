...
import { Headquarters, Procedure, Request as AppRequest, RequestStatus } from '../src/lib/types';
...
async function test() {
  ...
  if (!requests.find(r => r.id === reqId)) throw new Error("Request not found in HQ");
